...
/**
 * Handles position sizing calculations for scalping strategies
...
export class PositionSizer {
  ...
  calculatePositionSize(balance: number, signal: Signal, currentPrice: number, strategyBalance: StrategyBalance): number {
    ...
    console.log(`[PositionSizer:${this.variant}] Calculating position size:`, {
  ...
  private calculatePercentageBasedSize(totalAvailable: number, level: number, currentPrice: number): number {
    ...
    if (totalPotentialPercent > this.config.maxPositionPercent) {
      ...
      console.log(`[PositionSizer:${this.variant}] Scaling down position size to stay within max allocation:`, {
      ...
      console.log(`[PositionSizer:${this.variant}] Position size calculation:`, {
        level,
        levelMultiplier,
  ...
  private calculateFixedBasedSize(level: number, currentPrice: number): number {
    ...
    console.log(`[PositionSizer:${this.variant}] Fixed position size calculation:`, {
      level,
      levelMultiplier,
      baseAmount,
      dollarAmount,

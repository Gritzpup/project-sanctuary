...
impl CameraController {
    pub fn new(aspect: f32) -> Self {
        Self {
            eye: Point3::new(-10.0, 60.0, 30.0), // Elevated view for chart perspective
            target: Point3::new(15.0, 0.0, 0.0), // Look at center-right of chart
            up: Vector3::unit_y(),
            fov: 45.0,
            aspect,
            znear: 0.1,
    ...
    pub fn reset(&mut self) {
        self.eye = Point3::new(-10.0, 60.0, 30.0);
        self.target = Point3::new(15.0, 0.0, 0.0);

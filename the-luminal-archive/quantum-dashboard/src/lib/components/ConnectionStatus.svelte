<script lang="ts">
  ...
  $: connected = $quantumMemory.connected;
  $: error = $quantumMemory.error;
</script>

<div class="fixed top-4 right-4 z-50">
  <div class="bg-gray-800 rounded-lg px-4 py-2 flex items-center space-x-3">
    <div class="relative">
